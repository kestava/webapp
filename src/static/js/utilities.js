...
kestava.iso_8601_to_date = function(input)
{
...
kestava.get_fuzzy_time_ago = function(input)
{
    ...
    return (future ? 'On ' : '')
        + input.getDate()
        + ' '
        + kestava.get_month_string(input.getMonth())
        + ' '
        + input.getFullYear();
};

kestava.get_month_string = function(month)
{
    var months = [
        { 'name': 'Jan' },
        { 'name': 'Feb' },
