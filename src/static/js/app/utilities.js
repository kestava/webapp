...
app.utilities.preloadImages = (function() {
    var cache = [];
    return function(a) {
        var b, i;
        for (i in a) {
...
app.utilities.iso8601ToDate = function(input)
{
...
app.utilities.getFuzzyTimeAgo = function(input)
{
...
app.utilities.getMonthString = function(month)
{
    var months = [
        { 'name': 'Jan' },
        { 'name': 'Feb' },
